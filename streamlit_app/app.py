...
# ✅ Pipeline Status
st.sidebar.markdown("---")
st.sidebar.markdown("### 🛠️ Pipeline Info")
st.sidebar.markdown("- Feature Engineering: Manual via script")
st.sidebar.markdown("- **Inference:** Automated via GitHub Actions")
st.sidebar.markdown("- Model Registry: Linked to Feature View & Training Dataset")
